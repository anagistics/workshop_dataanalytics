...
Die Daten hier beschreiben verschiedene Süßigkeiten hinsichtlich verschiedener Eigenschaften und zudem wird für jede Süßigkeit ein Punktwert angegeben, der die Konsumentenpräferenz quantifiziert.

Informationen zum Datensatz unter https://github.com/fivethirtyeight/data/tree/master/candy-power-ranking

Die Daten werden mit dem folgenden Statement eingelesen:

```{r sweets_download, eval = FALSE}
sweets_url <- "https://raw.githubusercontent.com/fivethirtyeight/data/master/candy-power-ranking/candy-data.csv"
sweets <- readr::read_csv(sweets_url)
