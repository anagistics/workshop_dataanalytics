...
institute: "Allianz Lebensversicherungs-AG"
...
* ähnlich zu *Parallelkoordinaten* für kategorielle Variablen
* `R`-Pakete: `alluvial` oder 
* [Beispiel anhand des *Titanic*-Datensatzes}(https://cran.r-project.org/web/packages/alluvial/vignettes/alluvial.html)

![Titanic Alluvial](./img/titanic_alluvial.png)
