...
```{r img-conf, echo=FALSE, fig.align = 'center', out.width = "80%", fig.cap = "aus: Steven S. Skiena: The Data Science Design Manual"}
...
```{r img-mofi, echo=FALSE, fig.align = 'center', out.width = "60%", fig.cap = "aus: [2]"}
...
---
# Modelltypen: Entscheidungsbäume
...
.pull-right[
```{r img-dtree, echo=FALSE, fig.align = 'center', out.width = "100%", fig.cap = "aus: [1]"}
knitr::include_graphics("./img/dtree_example.png")
```  
]
...
```{r img-comp-lm-dtree, echo=FALSE, fig.align = 'center', out.width = "90%", fig.cap = "aus: [1]"}
...
.pull-left[
```{r img-log-reg-motv, echo=FALSE, fig.align = 'center', out.width = "140%", fig.cap = "aus: [2]"}
...
.pull-right[
```{r img-log-reg, echo=FALSE, fig.align = 'center', out.width = "150%", fig.cap = "aus: [2]"}
...
```{r img-cluster, echo=FALSE, fig.align = 'center', out.width = "60%", fig.cap = "aus: [²]"}
...
* $k$-Means-Algorithmus
```{r img-kmeans, echo=FALSE, fig.align = 'center', out.width = "80%", fig.cap = "aus: [2]"}
...
```{r img-cluster-iter, echo=FALSE, fig.align = 'center', out.width = "50%", fig.cap = "aus: [2]"}
