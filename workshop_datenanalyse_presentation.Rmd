...
Das hier passiert sehr oft in Unternehmen<sup>1</sup>:

.center[![:scale 40%](./img/phd_comics_vc.gif)]

.footnote[
[1] Bildquelle: [datascience.box](https://github.com/rstudio-education/datascience-box)
]

---
# Reproduzierbarkeit der Datenanalyse - Versionierung (2)

Versionsverwaltungssysteme<sup>1</sup> helfen bei der sicheren Verwaltung von Änderungen: * Nachverfolgen der Änderungen (was und durch wen) und 
* Verhinderung bzw. Behebung von Konflikten bei Zusammenführungen

.center[![:scale 60%](./img/lego-steps-commit-messages.png)]
...
Ein heute sehr verbreitetes Versionskontrollsystem ist [git](https://www.git-scm.com/). Ein vereinfachter Arbeitsfluss mit *git* sieht so aus<sup>1</sup>:

.center[![:scale 35%](./img/main-branches.png)]

.footnote[
[1] Bildquelle: [Git Workflow blog post](https://nvie.com/posts/a-successful-git-branching-model/)
]



---
# Reproduzierbarkeit der Datenanalyse (2)

* data lineage

---
# Reproduzierbarkeit der Datenanalyse (3)
