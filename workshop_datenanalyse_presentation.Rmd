...
```{r img-lin-reg, echo=FALSE, fig.align = 'center', out.width = "60%", fig.cap = "aus: James et al. (2013): An Introduction to Statistical Learning"}
...
.pull-right[
```{r img-dtree, echo=FALSE, fig.align = 'center', out.width = "100%", fig.cap = "aus: Sebastian Sauer: Moderne Datenanalyse mit R"}
...
```{r img-comp-lm-dtree, echo=FALSE, fig.align = 'center', out.width = "90%", fig.cap = "aus: Sebastian Sauer: Moderne Datenanalyse mit R"}
knitr::include_graphics("./img/comp-linear-dtree.png")
```  


---
# Modelltypen: Logistische Regression - Grundlagen

* Trotz des Namens: Klassifikationsmodell
...
$p(x) = \frac{e^{\beta_0+\beta_1\cdot x_1+\ldots+\beta_n\cdot x_n}}{1 + e^{\beta_0+\beta_1\cdot x_1+\ldots+\beta_n\cdot x_n}}$
  ...
  * Dann bildet man die *log odds* und erhält ein lineares Modell: 
.center[
...
```{r img-log-reg, echo=FALSE, fig.align = 'center', out.width = "80%", fig.cap = "aus: James et al. (2013): An Introduction to Statistical Learning"}

knitr::include_graphics("./img/logistic_regression.png")
```

* Wertebereich der logistischen Regression zwischen 0 und 1
* Entscheidung über Klasse: $p(x) > \theta \Rightarrow \text{Klasse 1}$
  * Erst durch diesen Vergleich mit einem (wählbaren) Schwellenwert wird aus der Regression eine Klassfikation.
...
```{r img-cluster, echo=FALSE, fig.align = 'center', out.width = "60%", fig.cap = "aus: James et al. (2013): An Introduction to Statistical Learning"}
...
* $k$-Means-Algorithmus
```{r img-kmeans, echo=FALSE, fig.align = 'center', out.width = "80%", fig.cap = "aus: James et al. (2013): An Introduction to Statistical Learning"}
...
```{r img-cluster-iter, echo=FALSE, fig.align = 'center', out.width = "50%", fig.cap = "aus: James et al. (2013): An Introduction to Statistical Learning"}
...
`r emo::ji("chef")` Dieses Baseline-Modell ist von der Praxis geleitet:
  ...
  * Ein einfaches lineares Regressionsmodell kann ein Baseline-Modell gg. komplexeren Modellen sein
...
---
# Vorgehen bei der Modellierung (1)
...
---
# Vorgehen bei der Modellierung (2)
...
$accuracy = \frac{TP + TN}{TP + TN + FP + FN}$
  ...
  * Darüberhinaus gibt es noch viele weitere Kriterien, s. Literatur.
...
```{r img-mofi, echo=FALSE, fig.align = 'center', out.width = "60%", fig.cap = "aus: James et al. (2013): An Introduction to Statistical Learning"}
...
* Sebastian Sauer: Moderne Datenanalyse mit R, Springer Gabler, 2019
* James Gareth, Daniela Witten, Trevor Hastie, Robert Tibshirani: An Introduction to Statistical Learning with Applications in R, Springer, 2013. Online erhältlich unter [https://www.statlearning.com/](https://www.statlearning.com/).
* Steven S. Skiena: The Data Science Design Manual, Springer, 2017

* YouTube-Kanal [Statistik am PC](https://www.youtube.com/c/StatistikamPC_BjoernWalther)
