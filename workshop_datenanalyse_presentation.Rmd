...
`r emo::ji("vulcan_salute")` Tag 1 - Theorie (überwiegend)
...
* Daten verstehen
    ...
    * Übung zur Datenvalidierung
* Visualisierung
    * Gruppenarbeit + Ergebnisvorstellung
* Herangehensweise: Hypothesenbildung
* Modellierung
* Reproduzierbarkeit der Datenanalyse
    * Gruppenarbeit + Ergebnisvorstellung

`r emo::ji("metal")` Tag 2 - Praxis

* Technisches Setup
    * Einführung in `R`:
* Gruppenarbeiten Datenanalyse
...
&rarr; Stattdessen Formulierung von *Hypothesen*: Vermutungen über fachliche relevante Sachverhalte:
  * *Verkäufe steigen im 4. Quartal jeden Jahres um mindestens 5%*
  * *Der Finanzierungsbedarf steigt mit jedem Kind um €50.000*
  * *Junge Akademiker unter 35 Jahren kaufen kapitalmarktnahe Lebensversicherungsprodukte*

&rarr; Hypothese mit Fachbereich abstimmen und positiv formulieren

&rarr; Aber in der Datenanalyse vom Gegenteil ausgehen (analog Hypothesentests in der Statistik)
...
* Dieses Zitat findet sich wohl in jedem Lehrbuch zum Thema: Weil es stimmt.

`r emo::ji("question")` Wozu Modellierung?

> *Modeling [...] is the process of encapsulating information into a tool which can forecast and make predictions. (Skiena: *The Data Science Design Manual*)


* Wesentliche Modelltypen:
  * **Regressionsmodell**: Quantitative abhängige Variable
  * **Klassifikationsmodell**: Qualitative abhängige Variable
