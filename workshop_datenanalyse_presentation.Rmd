...
Das Übungsblatt finden Sie unter [https://github.com/anagistics/workshop_dataanalytics/blob/master/uebungsblatt.pdf](https://github.com/anagistics/workshop_dataanalytics/blob/master/uebungsblatt.pdf)
...
```{r load_telco_data, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r show_telco_data, message=FALSE, warning=FALSE}
